...
(() => {
  ...
  filterContainer.addEventListener("click", (event) => {
    if (event.target.classList.contains("filter-item") &&
      !event.target.classList.contains("active")) {
      // diactivate exixting 'filter-item'
  ...
  function popupSlideshow() {
    ...
    popupImg.src = imgSrc;
    popupImg.onload = () => {
      // diactivate loader after the popupImg loaded
      popup.querySelector(".pp-loader").classList.remove("active");
    }
    popup.querySelector(".pp-counter").innerHTML = (slideIndex + 1) + " off " + screenshots.length;
  }
...
(() =>{
  ...
  function slider(){
    // deactivate exixting active slider
